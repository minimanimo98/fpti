  ...
  return (
    <main className="min-h-screen" style={{ background: '#FFE4D9', color: '#3D2817' }}>
      <div className="max-w-[480px] mx-auto px-6">
        ...
        {myToken && (
          <div
            className="mt-4 mb-4 p-4 rounded-2xl flex items-center justify-between"
            style={{
              background: '#fff',
          ...
          >
            ...
            <div className="flex gap-2 flex-shrink-0">
              ...
              <button
                ...
                className="w-9 h-9 flex items-center justify-center text-xs rounded-lg"
                style={{
                  background: '#fff',
                  color: '#A8826A',
        ...
        <header className="py-6 flex justify-center">
          <div className="flex items-center gap-2.5">
            ...
            <span style={{ fontFamily: 'var(--font-display)', fontSize: 20, color: '#3D2817' }}>FPTI</span>
          </div>
        </header>
        ...
        <div className="flex flex-col items-center pt-2 pb-4">
          <button
            onClick={cycleFace}
            aria-label="표정 바꾸기"
            style={{ background: 'transparent', border: 'none', cursor: 'pointer', padding: 0, marginBottom: 16 }}
          >
            <div
              style={{
                position: 'relative',
            ...
            >
              <div style={{ position: 'absolute', top: 8, left: 8, width: 8, height: 8, borderRadius: '50%', background: '#FF8A65' }} />
              <div style={{ position: 'absolute', top: 8, right: 8, width: 8, height: 8, borderRadius: '50%', background: '#FF8A65' }} />
              <div style={{ position: 'absolute', bottom: 8, left: 8, width: 8, height: 8, borderRadius: '50%', background: '#FF8A65' }} />
              <div style={{ position: 'absolute', bottom: 8, right: 8, width: 8, height: 8, borderRadius: '50%', background: '#FF8A65' }} />
              <div style={{
                position: 'absolute',
          ...
          <p className="text-xs" style={{ color: '#A8826A', fontFamily: 'var(--font-mono)' }}>
            탭해서 표정 바꾸기 ✨
          </p>
        </div>
        ...
        <section className="pb-8 text-center">
          <h1
            ...
            style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(34px, 9vw, 48px)', color: '#3D2817' }}
          >
            내 인성,<br />
            <span
              style={{
          ...
          {stats.users > 0 && (
            <p className="text-xs mt-1" style={{ color: '#A8826A' }}>
